...
In some scenes, a single move might carry you across an entire neighborhood; in others, that same move only gets you across a room. The scale of time and distance is always set by the scene.
On your turn, you can take two actions, then play passes to the next character.
